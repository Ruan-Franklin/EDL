...
public interface IABP {
     ...
     * @param elemento1 elemento a ser comparado
     * @param elemento2 elemento a ser comparado
     * @return "igual" se os elementos forem iguais, "primeiro elemento maior" se o primeiro elemento for maior que o segundo, "segundo elemento maior" se o primeiro elemento for menor que o segundo
     */
    public String comparar(Object elemento1, Object elemento2);
}

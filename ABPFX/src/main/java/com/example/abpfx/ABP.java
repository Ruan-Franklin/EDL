...
public class ABP implements IABP {
    ...
    public String comparar(Object elemento1, Object elemento2){
        int resultado = ((Integer) elemento1).compareTo((Integer) elemento2);
        if(resultado == 0){
            return "Os elementos são iguais";
        }
        else if(resultado == 1){
            return "O primeiro elemento é maior que o segundo";
        }
        else{
            return "O segundo elemento é maior que o primeiro";
        }
    }
